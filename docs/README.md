...
Follow guidelines for writing [content](/docs/guidelines/content-guidelines) and [code](/docs/guidelines/technical-guidelines). See how to create a [new repository](/guidelines/repository/) or a [new release](/guidelines/release/), and use [templates](/guidelines/templates/) for various document types.
